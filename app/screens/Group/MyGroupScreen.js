    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.buttons}>
                <TouchableOpacity 
                    style={styles.button}
                    onPress={() => navigation.navigate('MemberView')} // Điều hướng đến màn hình xem thành viên
                >
                    <Text style={styles.buttonText}>멤버 보기</Text>
                </TouchableOpacity>
                <TouchableOpacity 
                    style={[styles.button, styles.inviteButton]}
                    onPress={() => navigation.navigate('MemberInvite')} // Điều hướng đến màn hình mời thành viên
                >
            ...
            <View style={styles.memberSection}>
                ...
                <TouchableOpacity 
                    ...
                    onPress={() => navigation.navigate('MemberManage')} // Điều hướng đến màn hình quản lý thành viên
                >
